...
def main():
    ...
    #plt.scatter(train_data.inputs[:,0],train_data.inputs[:,1],c=train_data.labels)
    ...
    #rbf_with_gamma1 = lambda x, y: rbf_kernel(x, y, 1.0)
    #rbf_with_gamma2 = lambda x, y: rbf_kernel(x, y, 10.0/m)
